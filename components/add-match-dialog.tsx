...
export default function AddMatchDialog({ children }: { children: React.ReactNode }) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="player1" value={player1} onChange={(e) => setPlayer1(e.target.value)} className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="player2" className="text-right">
                选手2
              </Label>
              <Input id="player2" value={player2} onChange={(e) => setPlayer2(e.target.value)} className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="useAD" className="text-right">
                使用AD
              </Label>
              <Checkbox id="useAD" checked={useAD} onCheckedChange={(checked) => setUseAD(!!checked)} />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
